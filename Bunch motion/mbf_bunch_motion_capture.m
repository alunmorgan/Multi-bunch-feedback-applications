...
% Arming the systems
mbf_get_then_put({[pv_head_T pv_names.tails.MEM_arm];...
    [pv_head_L pv_names.tails.MEM_arm]},1);
...
[bunch_motion.x, bunch_motion.y] = mbf_read_mem(pv_names.hardware_names.T, turn_count,'offset', turn_offset,'channel', -1, 'lock', 60);
