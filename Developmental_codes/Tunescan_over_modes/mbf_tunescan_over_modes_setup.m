function tunes = mbf_tunescan_over_modes_setup(mbf_axis, tune, varargin)
...
%
% example: mbf_tunescan_setup('x', 0.17)
...
% then get the tunes
setup_operational_mode(mbf_axis, "TuneSpecial")
% Get the tunes
...
lcaPut([pv_head, Sequencer.Base, ':1', Sequencer.start_frequency], 0);
lcaPut([pv_head, Sequencer.Base, ':1', Sequencer.step_frequency],1); %FIXME
...
lcaPut([pv_head, Sequencer.Base, Super_sequencer_count], harmonic_number -1);
