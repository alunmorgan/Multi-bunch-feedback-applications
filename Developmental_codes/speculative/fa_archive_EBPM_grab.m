...
% yyymmddTHHMMSS.
% opttionally saves the results to a file, named by the pv name in the folder
...
if nargin >1
    save(fullfile(output_location, ...
        ['EBPM_fa_data-',time_range{1}, '_to_', time_range{2} '.mat']),...
        'pv_data', '-v7.3')
end %if
if nargout == 1
    varargout{1} = pv_data;
