...
for i = 1:length(emittance_blowup.scan)
    emittance_blowup_pp.beam_oscillation_x(i) = std(emittance_blowup.scan{i}.bpm_data.SR23C_DI_EBPM_01.X);
    emittance_blowup_pp.beam_oscillation_y(i) = std(emittance_blowup.scan{i}.bpm_data.SR23C_DI_EBPM_01.Y);
