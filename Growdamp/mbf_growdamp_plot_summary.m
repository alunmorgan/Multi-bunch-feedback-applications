...
x_plt_axis = (0:harmonic_number) - harmonic_number/2;
passive_data = cat(1, NaN, squeeze(poly_data(:,2,1)));
active_data = cat(1, NaN, squeeze(poly_data(:,3,1)));
f_shifts = cat(1, NaN, frequency_shifts);
figure
ax1 = subplot(3,1,1:2);
