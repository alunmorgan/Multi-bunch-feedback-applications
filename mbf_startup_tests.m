...
fir_gain_s = get_variable('SR23C-DI-LMBF-01:IQ:FIR:GAIN_S');
...
try
    ...
    set_variable('SR23C-DI-LMBF-01:IQ:FIR:GAIN_S', '0dB')
...
set_variable('SR23C-DI-TMBF-01:X:FIR:GAIN_S', fir_gain_x );
set_variable('SR23C-DI-TMBF-01:Y:FIR:GAIN_S', fir_gain_y);
set_variable('SR23C-DI-LMBF-01:IQ:FIR:GAIN_S', fir_gain_s);