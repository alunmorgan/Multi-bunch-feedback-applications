...
if ~isempty(modescan_x_files)
    try
        ...
        mbf_modescan_plotting(data_magnitude_x, data_phase_x, modescan_x.data.harmonic_number)
    catch
...
if ~isempty(modescan_y_files)
    try
        ...
        mbf_modescan_plotting(data_magnitude_y, data_phase_y, modescan_y.data.harmonic_number)
    catch
...
if ~isempty(modescan_s_files)
    try
        ...
        mbf_modescan_plotting(data_magnitude_s, data_phase_s, modescan_s.data.harmonic_number)
    catch
